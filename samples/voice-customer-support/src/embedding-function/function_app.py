...
Simple REST API to generate text embeddings using Azure OpenAI text-embedding-3-small.
...
def generate_embedding(req: func.HttpRequest) -> func.HttpResponse:
    ...
    Response: {"embedding": [0.1, 0.2, ...], "dimensions": 1536, "model": "text-embedding-3-small"}
    """
